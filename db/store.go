// Package store provides a gossip data store interface.
package store
...
// Store is a gossip data store interface.
...
// UserStore is a gossip user data store interface.
...
// TopicStore is a gossip topic data store interface.
...
// CommentStore is a gossip comment data store interface.
